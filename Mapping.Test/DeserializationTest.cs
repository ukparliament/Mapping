...
namespace Mapping.Test
{
    ...
    public class DeserializationTest
    {
        ...
        public void DeserializeTest()
        {
            ...
            object approval = createClassInstance("Approval");
            IEnumerable<BaseResource> ontologyInstances = serializer.Deserialize(graph, approval.GetType().Assembly, new Uri(nameSpace));
            Assert.IsTrue(ontologyInstances.ToList().Where(oi => oi.GetType() == approval.GetType()).Any());
        }
